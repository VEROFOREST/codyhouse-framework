    ...
    <nav class="header__nav js-header__nav" id="header-nav" role="navigation" aria-label="Main">
      <div class="header__nav-inner">
        ...
        <ul class="header__list">
          <li class="header__item"><a href="../layout.php" class="header__link">Home</a></li>
          <li class="header__item"><a href="./views/maps.php" class="header__link">Find a Yacht</a></li>
          <li class="header__item"><a href="0"# class="header__link" aria-current="page">About Us</a></li>
          ...
          <li class="header__item"><a href="../views/maps.php" class="btn btn--primary">Book a Yacht </a></li>
        </ul>
      </div>
    </nav>
  </div>
...
<script src="../assets/js/_1_header.js"></script>
</body>
</html>